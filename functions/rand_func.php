<?php
  ...
  $d = "$hours:$min:$seconds";
  $tgl = Date('Y-m-d');
  $query = "INSERT INTO bangsal1(tranportirtujuan,nopol,kosong,isi,total,rotto,bcu,sebelum,sesudah,bangsal,lonumber,nospa,sppbe,kapasitas,driver,masuk,keluar,durasi,tanggal) VALUES ('".$tt."','".$np."','".$k."','".$i."','".$t."','".$rot."','".$bcu."','".$sb."','".$ss."','".$bang."','".$lo."','".$nospa."','".$sppbe."','".$kap."','".$nd."','".$jm."','".$jk."','".$d."','".$tgl."');";
