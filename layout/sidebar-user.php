        ...
        $dashboard = "/opsico4/kadept.php";
          ...
          $dashboard = "/opsico4/supervisor-ad.php";
            ...
            $dashboard = "/opsico4/supervisor-pp.php";
              ...
              $dashboard = "/opsico4/supervisor-p.php";
            } else if($hak == '107'){
...
<aside>
    <div id="sidebar"  class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
            ...
            <li class="mt">
                <a href="<?php echo $dashboard; ?>?dashboard=tahunan">
            ...
            <li class="sub-menu">
                <a onclick="document.location.href = 'http://localhost/opsico4/transaksi/kettrans.php?hak=<?php echo $hak  ?>'" href="javascript:;" >
...
function ganti() {
  document.location.href = http://localhost/opsico4/supervisor-ad.php;
}
</script>
